...
class ScoreNotifier extends Notifier<List<Game>> {
  ...
  List<Game> build() {
    ...
    // Start loading but return empty list as initial state
  ...
  Future<void> _loadGames() async {
    ...
    try {
      ...
      if (await file.exists()) {
        ...
        state = jsonList.map((e) => Game.fromJson(e as Map<String, dynamic>)).toList();
  ...
  Future<void> _saveGames() async {
    ...
    try {
      ...
      final jsonList = state.map((g) => g.toJson()).toList();
  ...
  void deleteGame(String id) {
    ...
    void addRoundToGame(String gameId, Round round) {
    ...
    void updateRoundInGame(String gameId, Round updatedRound) {
...
final scoreProvider =
    ...
    NotifierProvider<ScoreNotifier, List<Game>>(ScoreNotifier.new);
...
class BaseScoresNotifier extends Notifier<Map<String, int>> {
  ...
  Map<String, int> build() {
    ...
    Future.microtask(() => _loadBaseScores());
